...
export default function Header() {
    ...
    return (
        <header
            className={cn(
                "px-4 sticky top-0 z-50 h-[100px] bg-[#CBCBCB] flex items-center",
                scrolled &&
        ...
        >
            <div className="mx-auto w-full max-w-screen-2xl flex flex-row gap-2 justify-between items-center pr-2 lg:pr-4">
                ...
                <Button asChild className="bg-[#2E4F21] text-[#FFFDF4] hover:bg-[#27451c] text-xs sm:text-sm px-2 sm:px-3 py-2">
                    <Link href="#waitlist">
