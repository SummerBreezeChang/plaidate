...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col bg-background">
      {/* Header */}
      <header className="w-full py-4 px-6 md:px-12 flex items-center justify-between border-b border-none bg-background">
      ...
      <section className="w-full px-6 md:px-12 py-20 bg-primary-foreground">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-3xl tracking-tight text-balance leading-tight md:text-4xl font-semibold font-mono">
